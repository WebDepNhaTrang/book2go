...
@section('head')
    <link rel="stylesheet" type="text/css" href="{{asset('vendor/core/css/animated-svg-avatar.css')}}">
@endsection
    ...
    <div class="content-wrapper">
        {!! Form::open(['route' => 'access.login', 'class' => 'login-form']) !!}
            ...
            <div class="inputGroup inputGroup1">
                <label class="control-label" id="loginEmailLabel">{{ trans('core.acl::auth.login.username') }}</label>
                {!! Form::text('username', old('username', null), ['class' => '', 'id' => 'loginEmail']) !!}
                <p class="helper helper1">{{trans('core.acl::auth.login.username')}}</p>
            </div>

            <div class="inputGroup inputGroup2">
                <label class="control-label" id="loginPasswordLabel">{{ trans('core.acl::auth.login.password') }}</label>
                {!! Form::input('password', 'password', null, ['class' => '', 'placeholder' => trans('core.acl::auth.login.password') , 'id' => 'loginPassword']) !!}
                <label id="showPasswordToggle" for="showPasswordCheck">Show
               
                    {!! Form::checkbox('showPasswordCheck', '1', null, ['id' => 'showPasswordCheck']) !!}
...
@push('footer')
    ...
    <script type="text/javascript" src="{{asset('vendor/core/js/app_modules/animated-svg-avatar.js')}}"></script>
@endpush