        ...
        <div class="col-md-9">
            <div class="main-form">
                <div class="form-body">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group @if ($errors->has('first_name')) has-error @endif">
                                <label for="first_name" class="control-label required">{{ trans('core.acl::users.info.first_name') }}</label>
                        ...
                        <div class="col-md-6">
                            <div class="form-group @if ($errors->has('last_name')) has-error @endif">
                                <label for="last_name" class="control-label required">{{ trans('core.acl::users.info.last_name') }}</label>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group @if ($errors->has('username')) has-error @endif">
                                <label for="username" class="control-label required">{{ trans('core.acl::users.username') }}</label>
                        ...
                        <div class="col-md-6">
                            <div class="form-group @if ($errors->has('email')) has-error @endif">
                                <label for="email" class="control-label required">{{ trans('core.acl::users.email') }}</label>
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-xs-12">
                            <div class="form-group">
                                <label class="control-label required" for="password">{{ trans('core.acl::users.password') }}</label>
                        ...
                        <div class="col-sm-6 col-xs-12">
                            <div class="form-group">
                                <label class="control-label required" for="password_confirmation">{{ trans('core.acl::users.confirm_new_password') }}</label>
                    ...
                    <div class="form-group">
                        <label class="control-label required" for="role">{{ trans('core.acl::users.role') }}</label>
