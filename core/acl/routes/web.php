...
Route::group(['namespace' => 'Botble\ACL\Http\Controllers', 'middleware' => 'web'], function () {
    ...
    Route::group(['prefix' => config('core.base.general.admin_dir'), 'middleware' => 'auth'], function () {
        ...
        Route::group(['prefix' => 'oauth'], function () {
            Route::get('/clients', [
                'as' => 'oauth.clients',
                'uses' => 'OAuthController@getClients',
            ]);
            Route::get('/clients/create', [
                'as' => 'oauth.clients.create',
                'uses' => 'OAuthController@getCreateClient',
            ]);
            Route::post('/clients/create', [
                'as' => 'oauth.clients.create.post',
                'uses' => 'OAuthController@postCreateClient',
            ]);
            Route::get('/clients/edit/{id}', [
                'as' => 'oauth.clients.edit',
                'uses' => 'OAuthController@getEditClient',
            ]);
            Route::post('/clients/edit/{id}', [
                'as' => 'oauth.clients.edit.post',
                'uses' => 'OAuthController@postEditClient',
            ]);
            Route::get('/clients/delete/{id}', [
                'as' => 'oauth.clients.delete',
                'uses' => 'OAuthController@getDeleteClient',
            ]);
            Route::delete('/clients/edit/{id}', [
                'as' => 'oauth.clients.delete.post',
                'uses' => 'OAuthController@postDeleteClient',
            ]);
        });
    });
