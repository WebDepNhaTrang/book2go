...
class MenuTable extends TableAbstract
{
    ...
    {
        $model = app(MenuInterface::class)->getModel();
        /**
         * @var \Eloquent $model
         */
        $query = $model->select(['menus.id', 'menus.name', 'menus.created_at', 'menus.status']);
    ...
    {
        return MENU_MODULE_SCREEN_NAME;
    }
}
