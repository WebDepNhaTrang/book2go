...
@section('head')
    ...
    <link rel="stylesheet" type="text/css" href="{{ url('vendor/core/packages/fontawesome-iconpicker/css/fontawesome-iconpicker.min.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ url('vendor/core/packages/fontselect/fontselect-default.css') }}">
@endsection

@push('footer')
    <script type="text/javascript" src="{{ url('vendor/core/packages/fontawesome-iconpicker/js/fontawesome-iconpicker.min.js') }}">
    </script>
