...
class LanguageServiceProvider extends ServiceProvider
{
     ...
     * @author Sang Nguyen
     */
    public function checkItemLanguageBeforeGetAdminListItem($data, $model, $screen)
    {
    ...
    public function addLanguageSwitcherToTable($buttons, $screen)
    {
        if (in_array($screen, Language::screenUsingMultiLanguage())) {
            ...
            $language_buttons[] = [
                ...
                'text' => '<span data-href="' . route('languages.change.data.language', 'all') . '">' . trans('plugins.language::language.show_all') . '</span>',
            ];
            ...
            $language = [
                'language' => [
                    'extend' => 'collection',
                    'text' => $flag . ' <span> ' . trans('plugins.language::language.change_language') . ' <span class="caret"></span></span>',
    ...
    {
        if (in_array($screen, Language::screenUsingMultiLanguage()) && !empty($language_code)) {
            $table = $model->getTable();
